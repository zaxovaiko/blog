...
export const metadata = {
  ...
  description:
    "Should you migrate a bare React Native project to Expo? Pros, cons, and practical experience from a real project.",
  openGraph: { type: "article", images: "/posts/should-i-migrate-to-expo/opengraph-image" },
