...
export const metadata = {
  ...
  description:
    "A cautionary story about using push triggers for GitHub Actions and how it can spam CI/minutes — safer alternatives explained.",
  openGraph: { type: "article", images: "/posts/why-you-should-avoid-using-push-events-on-github-actions/opengraph-image" },
...
- `--jq ".[] | .databaseId` - extracts the `databaseId` field from the JSON output. [Here is the manual](https://stedolan.github.io/jq/manual/), if you don’t believe me
